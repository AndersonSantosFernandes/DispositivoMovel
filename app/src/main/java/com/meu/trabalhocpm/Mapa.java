...
import com.meu.trabalhocpm.databinding.ActivityMapaBinding;

import java.util.ArrayList;

public class Mapa extends FragmentActivity implements OnMapReadyCallback, Mapa1 {
    ...
    public void onLocationChanged(@NonNull Location location) {
        Marker currentLocationMaker = null;
